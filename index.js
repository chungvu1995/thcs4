...
var count = 0;
var client = mqtt.connect("mqtt://localhost:1883",{clientId:"mqttjs01",username:"chung",password:"123"});
var topic1 = "Topic 1";
var topic2 = "Topic 2";
var topic3 = "Topic 3";
...
var server = app.listen(4000, () => { 
    console.log("Conect to requests on port 4000...");
})

var connection = mysql.createConnection({
	host     : 'localhost',
	user     : 'mangcambien-user',
	password : '123456',
	database : 'thcs4'
});
